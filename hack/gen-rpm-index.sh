...
docker run --rm -i arti.dev.cray.com/internal-docker-stable-local/packaging-tools:0.11.0 rpm-index -v \
    ...
    -d  https://artifactory.algol60.net/artifactory/sles-mirror/Updates/SLE-Module-Public-Cloud/15-SP2/x86_64/update/x86_64         suse/SLE-Module-Public-Cloud/15-SP2/x86_64/update \
