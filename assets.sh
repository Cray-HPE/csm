...
KUBERNETES_ASSETS=(
    https://artifactory.algol60.net/artifactory/csm-node-images/kubernetes/0.0.57/kubernetes-0.0.57.squashfs
    https://artifactory.algol60.net/artifactory/csm-node-images/kubernetes/0.0.57/5.3.18-24.75-default-0.0.57.kernel
    https://artifactory.algol60.net/artifactory/csm-node-images/kubernetes/0.0.57/initrd.img-0.0.57.xz
)

STORAGE_CEPH_ASSETS=(
    https://artifactory.algol60.net/artifactory/csm-node-images/storage-ceph/0.0.47/storage-ceph-0.0.47.squashfs
    https://artifactory.algol60.net/artifactory/csm-node-images/storage-ceph/0.0.47/5.3.18-24.75-default-0.0.47.kernel
    https://artifactory.algol60.net/artifactory/csm-node-images/storage-ceph/0.0.47/initrd.img-0.0.47.xz
)
